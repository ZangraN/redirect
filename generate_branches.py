...
branches = [
    ...
    },
    {
        ...
        "name": "Брест",
        "is_main": False,
        "phone_display": "+375 (29) 374-37-69",
        "phone_raw": "+375293743769"
    },
    {
        "id": "minsk-korzhenevskogo",
        "name": "Минск Корженевского",
        "is_main": False,
        "phone_display": "+375 (29) 653-86-53",
        "phone_raw": "+375296538653"
    },
    {
        "id": "mozyr",
        "name": "Мозырь",
        "is_main": False,
        "phone_display": "+375 (44) 592-01-56",
        "phone_raw": "+375445920156"
    },
    {
        "id": "vitebsk",
        "name": "Витебск",
        "is_main": False,
        "phone_display": "+375 (29) 641-95-39",
        "phone_raw": "+375296419539"
    },
    {
        "id": "baranovichi-nakonechnikova",
        "name": "Барановичи Наконечникова",
        "is_main": False,
        "phone_display": "+375 (29) 641-81-20",
        "phone_raw": "+375296418120"
    },
    {
        "id": "baranovichi-telmana",
        "name": "Барановичи Тельмана",
        "is_main": False,
        "phone_display": "+375 (29) 641-92-05",
        "phone_raw": "+375296419205"
    },
    {
        "id": "bobruisk",
        "name": "Бобруйск",
        "is_main": False,
        "phone_display": "+375 (29) 641-91-87",
        "phone_raw": "+375296419187"
    },
    {
        "id": "minsk-uborevicha",
    ...
    },
    {
        ...
        "name": "Слуцк Ленина",
        "is_main": False,
        "phone_display": "+375 (44) 755-92-46",
        "phone_raw": "+375447559246"
    },
    {
        "id": "minsk-ilimskaya",
        "name": "Минск, Илимская",
        "is_main": False,
        "phone_display": "+375 (44) 592-86-43",
        "phone_raw": "+375445928643"
    }
]
...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700;900&family=Outfit:wght@300;400;600;800&display=swap" rel="stylesheet">
    ...
    <style>
        :root {{
            ...
            --bg-color-2: #141416;
            --bg-color-3: #050506;
            --accent-red: #e30613; /* Фирменный красный цвет автохауса */
            --accent-red-hover: #ff1f2d;
            --text-main: #ffffff;
            --text-muted: rgba(255, 255, 255, 0.6);
            --card-bg: rgba(25, 25, 28, 0.6);
            --card-border: rgba(227, 6, 19, 0.15);
            --glow-color: rgba(227, 6, 19, 0.35);
        }}
        ...
        * {{
        ...
        /* Светящиеся красные сферы на фоне */
        .blob {{
            position: absolute;
            width: 350px;
            height: 350px;
        ...
        .blob-1 {{
            top: -80px;
            left: -80px;
            background: radial-gradient(circle, rgba(227, 6, 19, 0.4) 0%, rgba(0,0,0,0) 70%);
        }}
        ...
        /* Премиальная карточка в авто-стиле */
        .card {{
        ...
        /* Иконка звонка с анимацией пульсации */
        .icon-container {{
            width: 84px;
            height: 84px;
            margin: 0 auto 28px;
        ...
        .dots::after {{
            content: '';
            animation: dotty 1.5s infinite steps(4);
        }}
...
<body>
    ...
    <!-- Фоновые эффекты размытия -->
    <div class="blob blob-1"></div>
    <div class="blob blob-2"></div>

    <!-- Карточка перенаправления -->
    <div class="card" id="card">
        <!-- Логотип BUTIKAVTO -->
        <div class="brand-logo">
            <span class="logo-butik">BUTIK</span><span class="logo-avto">AVTO</span>
        </div>
        ...
        <h1>Вызов<span class="dots"></span></h1>
        ...
        <!-- Кнопка вызова -->
        <a href="tel:{phone_raw}" class="call-btn" id="callLink">
            <svg viewBox="0 0 24 24">
                <path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56a.977.977 0 0 0-1.01.24l-2.2 2.2a15.045 15.045 0 0 1-6.59-6.59l2.2-2.21a.96.96 0 0 0 .25-1A11.36 11.36 0 0 1 8.5 4c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.5c0-.55-.45-1-1-1z"></path>
            </svg>
            Позвонить
        </a>
    </div>
    ...
    <script>
        ...
        // 1. Попытка немедленного вызова при инициализации скрипта
        triggerCall();

        // 2. Попытка вызова после полной загрузки документа
        window.addEventListener('DOMContentLoaded', () => {{
            setTimeout(triggerCall, 150);
        }});

        // 3. Обработка клика по карточке
        document.getElementById('card').addEventListener('click', (e) => {{
            if (!e.target.closest('#callLink')) {{
                triggerCall();
            }}
        }});
    </script>
